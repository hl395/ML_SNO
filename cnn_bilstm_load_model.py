...
def main(_):
    ...
    print("Evaluate: ", "acc: {} \t loss: {}".format(np.mean(eval_history), np.mean(eval_history)))
    ...
    for x, y in get_batches_elmo_multi(predict_examples, embed=embedding_result, embed_2=embedding_result_2, batch_size=FLAGS.batch_size):
        ...
        print(result[1])
        result = np.where(result > 0.01, 1, 0)
...
if __name__ == "__main__":
    ...
    FLAGS.data_dir = "SNO/TestData/Iteration_5/"
    FLAGS.learning_rate = 0.00001
    FLAGS.output_dir = "cnnModel/elmo/Iteration_5/"
