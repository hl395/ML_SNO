...
if __name__ == "__main__":
    ...
    FLAGS.output_dir = FLAGS.directory_path +"cnnModel/" + FLAGS.hier_name + "/multi_models/Iteration_8/" + FLAGS.taxonomy + "/2docvec/"
    FLAGS.vector_model_path = FLAGS.directory_path + "vectorModel/" + FLAGS.hier_name + "/" + str(FLAGS.iterations) + "/"
    FLAGS.saved_model_name = "concept_100_2docvec_model"
