...
img_path = directory_path + "img/attention_dilated/"
#############################################################################################################
...
# for iterations in iterations_list:
    ...
    with graph.as_default():
        attention_output, alphas = attention(max_pool_6, ATTENTION_SIZE, return_alphas=True)
        flat = tf.nn.dropout(attention_output, keep_prob=keep_prob_)
